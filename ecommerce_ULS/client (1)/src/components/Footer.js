  ...
  return (
    <div className='footer-container'>
      <div className='footer-section'>
        <h3>About Us</h3>
        <p>
          SOMA is an online shopping platform that offers a wide range of
      ...
      <div className='footer-section'>
        ...
        <ul className='footer-list'>
          <li className='navitem forcou1' onClick={allCategory}>
            All Products
          </li>
          <li className='navitem forcou1' onClick={men}>
            Men
          </li>
          <li className='navitem forcou1' onClick={women}>
            Women
          </li>
        </ul>
      </div>
